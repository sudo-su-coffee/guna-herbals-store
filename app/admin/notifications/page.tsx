...
export default function NotificationsPage() {
    ...
    return (
        <div className="space-y-6 pb-12">
            <AdminPageHeader title="Notifications" description="Operational alerts from orders and customer enquiries." primaryAction={{ label: 'Refresh', onClick: load, icon: <Icon name="refresh" size={15} /> }} />
