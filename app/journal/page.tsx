...
export const metadata: Metadata = {
    title: "The Herbal Journal - Guna's Wisdom",
    description: "Explore the ancient secrets of Siddha medicine, hair care rituals, and the science behind our ingredients.",
};
