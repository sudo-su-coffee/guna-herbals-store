...
export const metadata: Metadata = {
    title: "Herbal Formulation Workshops & Training",
    description: "Join the Guna Academy in Tenkasi to learn the art of making organic soaps, herbal oils, and shampoos from expert artisans.",
};
            ...
            <div className="max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-24">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center mb-16 md:mb-24">
                    <div className="order-2 md:order-1">
                        ...
                        <Link
                            href="/contact?type=workshop" // Assuming contact handles enquiry types
                            className="bg-herbal-800 text-white px-8 py-3 md:py-4 rounded-lg font-bold uppercase tracking-widest hover:bg-herbal-900 shadow-lg text-xs md:text-sm w-full md:w-auto inline-block text-center"
                        >
                            Request Syllabus
                        </Link>
                    </div>
